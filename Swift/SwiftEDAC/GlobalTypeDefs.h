...
#if MODULTN_SCHEME!=OOK
#define PHOTO_DEL_CYCLES							11//round((PACKET_SIZE/(2*N_LAMBDA))*(1/DATA_RATE)*(1/CONST_TIME))
#else
#define PHOTO_DEL_CYCLES							10//round((PACKET_SIZE/(N_LAMBDA))*(1/DATA_RATE)*(1/CONST_TIME))
#endif
