...
#define NOC_PHOTONIC_CLK							0.2//0.059 Corresponds to 17Gbps
...
#if MODULTN_SCHEME!=OOK
#define PHOTO_DEL_CYCLES							13//round((PACKET_SIZE/(2*N_LAMBDA))*(1/DATA_RATE)*(1/CONST_TIME))
#else
#define PHOTO_DEL_CYCLES							32//round((PACKET_SIZE/(N_LAMBDA))*(1/DATA_RATE)*(1/CONST_TIME))
#endif
