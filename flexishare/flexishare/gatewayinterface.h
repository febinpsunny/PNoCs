...
SC_MODULE(TGatewayInterface)
{
  ...
  sc_out<TFlit>                  mwmr_data_tx[(DEFAULT_MESH_DIM_X * DEFAULT_MESH_DIM_Y)/2];
  sc_in<TFlit>                   mwmr_data_rx[(DEFAULT_MESH_DIM_X * DEFAULT_MESH_DIM_Y)/2];
